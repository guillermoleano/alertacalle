...
export default function Reportar() {
    ...
    function addFakeFile() {
        ...
        setFiles(f => [...f, `foto_${f.length + 1}.jpg`]);
    }
                            ...
                            <div className="p-6 md:p-8 space-y-5 animate-in fade-in slide-in-from-right-4 duration-250">
                                ...
                                <div className="relative h-36 overflow-hidden rounded-xl bg-[#eef1f8] border border-[var(--ac-outline-variant)]">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <span className="flex size-10 items-center justify-center rounded-full border-2 border-[var(--ac-primary)] bg-white shadow-md">
                                            <MapPin className="size-5 text-[var(--ac-primary)]" />
                                        </span>
                                    </div>
                                    <button type="button" className="absolute top-2 right-2 inline-flex items-center gap-1.5 rounded-lg bg-white/90 px-2.5 py-1.5 text-[11px] font-bold text-[var(--ac-primary)] shadow-sm backdrop-blur-sm transition-all hover:bg-white active:scale-95">
                            ...
                            <div className="p-6 md:p-8 space-y-5 animate-in fade-in slide-in-from-right-4 duration-250">
                                ...
                                {files.length > 0 && (
                                    <div className="flex flex-wrap gap-2">
                                        {files.map((f, i) => (
                                            <div key={i} className="flex items-center gap-2 rounded-xl border border-[var(--ac-outline-variant)] bg-[var(--ac-surface-container-low)] px-3 py-2 text-[12px] font-semibold text-[var(--ac-on-surface)]">
                                                <Camera className="size-3.5 text-[var(--ac-secondary)]" />
                                                {f}
                                                <button type="button" onClick={() => removeFile(i)} className="ml-1 text-[var(--ac-outline)] hover:text-red-500 transition-colors">
